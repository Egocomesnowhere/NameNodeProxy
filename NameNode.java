...
import org.apache.hadoop.hdfs.server.namenode.NameNodeProxy;
...
*/
    // use nnProxy
    nnProxy=new NameNodeProxy(this);
    this.server = RPC.getServer(nnProxy,  socAddr.getHostName(), socAddr.getPort(),  
  ...
  public static void main(String argv[]) throws Exception {
    ...
    //  System.out.println(conf.get("dir"));
      if (namenode != null)
        namenode.join();
    } catch (Throwable e) {
      LOG.error(StringUtils.stringifyException(e));
